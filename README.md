...
- Telos UI uses `@telosplatforms/ai-kit@0.1.1`, supplied with this skill as a [verified release download](https://github.com/telosplatforms1/telos-partner-starter/releases/download/v0.1.8/telosplatforms-ai-kit-0.1.1.tgz), with React, React DOM, and `next-themes`. It includes the maintained design-system catalog. The skill downloads and installs this archive during design-system setup, then serves its bundled catalog. Installing the skill alone does not install the package.
