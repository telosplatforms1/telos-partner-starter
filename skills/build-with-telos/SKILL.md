...
- Record the user's chosen authentication approach, theme file, design choices, and color-mode preference alongside the Telos guidance so subsequent work preserves them without repeating onboarding questions. Never record credentials.
