...
5. Once the design system is installed, start Storybook following [UI kit](references/ui-kit.md), verify it is running, and share its local URL with the patron.
