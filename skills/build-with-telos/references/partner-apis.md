...
- Use the verified neutral `@telosplatforms/ai-kit@0.2.0` release archive described in [UI kit](ui-kit.md); it includes the maintained public catalog and theme template.
