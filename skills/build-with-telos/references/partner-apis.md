...
- The UI kit release uses `@telosplatforms/ai-kit`. Verify an available registry version or Telos-supplied artifact before installation; report missing access if unavailable.
