...
- Telos UI uses the neutral `@telosplatforms/ai-kit@0.2.0` archive from the [kit 0.2.0 GitHub release](https://github.com/telosplatforms1/telos-partner-starter/releases/tag/ai-kit-v0.2.0). The [archive](https://github.com/telosplatforms1/telos-partner-starter/releases/download/ai-kit-v0.2.0/telosplatforms-ai-kit-0.2.0.tgz) and [SHA256SUMS](https://github.com/telosplatforms1/telos-partner-starter/releases/download/ai-kit-v0.2.0/SHA256SUMS) are independently downloadable; the skill verifies the checksum before installation. It includes the maintained component catalog and theme template, then copies the catalog into the project preview directory and applies the project-owned theme. Installing the skill alone does not install the package.
